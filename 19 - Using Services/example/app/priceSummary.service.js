...
var PricingSummaryService = (function () {
    ...
    PricingSummaryService.prototype.getTotalSumOfPrices = function () {
        var sum = 0;
        this.prices.forEach(function (p) { return sum + p; });
        console.info("total sum of Prices:" + sum);
        return sum;
    };
    PricingSummaryService.prototype.getAveragePrice = function () {
        var average = this.getTotalSumOfPrices() / this.prices.length;
        console.info("average Price:" + average);
        return average;
    };
    PricingSummaryService.prototype.deriveSummaryFromPrices = function () {
